...
#'
#' @description The getminipackage contains two functions called getBiotypes and
...
#'   any genomic loci of interest.The getReadthrough function is used to find
#'   long transcripts that covers more than two coding regions of a genome.
#'
...
#'
#' @details For details of findOverlaps, type.partialOverlap, type.50Overlap and
#' type.toPlot, see:
...
#'
#' @return Returns the classified transcriptome biotypes and overlapping transcripts.
#'
