...
```
<center> ![Fig 1. NPS workflow with five key analytic steps](Fig1.jpg) </center>
...
#### __Quick Start__
  ...
  The general overview of how our package is shown here.Further uses of our
  package are illustrated in the sections below. First start by loading the
  required libraries: “GenomeInfoDb,” "NPS," "GenomicRanges," "IRanges" and
  "NPS". Next load the datasets: "gencode", "ILEF", "intron" and "cod". Using
  these datasets, excute NPS functions getBiotypes and getReadthrough as
  follows.These steps assume you installed the “NPS” package. If you did not
  install the package, use the `install.packages("NPS")`to install in R.
...
#### __Genomic Data Source__ 
  ...
  The table above contains a chr21 dataset which was extracted from a full
  genome dataset. An extraction method is described under `filtering chr21
  gencode` below.
...
***
    ...
    # Samples reads with overlapping of two coding regions indicate expression
    over two coding 
