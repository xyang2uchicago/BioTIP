...
```{r, echo=FALSE, fig.cap="Fig 1. BioTIP workflow with five key analytical steps. RTF: relative transcript fluctuation; PCC: Pearson correlation coefficient; MCI: Module-Criticality Index; Ic: index of critical transition.", fig.align='center', out.width = '60%'}
...
```
   * [An Identification of Critical Tipping Point using Bulk RNA-seq](#An Identification of Critical Tipping Point using Bulk RNA-seq)
     ...
     *  ##### [Identifying Dynamic Network Biomodule (Module-Criticality Index (MCI))](#Identifying Dynamic Network Biomodule (Module-Criticality Index (MCI)))
   ...
   * [Applying to scRNA-seq Data](#Applying to scRNA-seq Data)
     ...
     *  ##### [Identifying Dynamic Network Biomodule (MCI)](#Identifying Dynamic Network Biomodule (MCI))
     *  ##### [Finding Tipping Point (Random Permutation and Delta Score)](#Finding Tipping Point (Random Permutation and Delta Score))
...
[Go to Top](#)</a> 
<a name="Identifying Dynamic Network Biomodule (Module-Criticality Index (MCI))"></a>

__Identifying Dynamic Network Biomodule (Module-Criticality Index (MCI))__
...
#To install package, use R (version 4.0) and enter:
...
counts = read.table("/Users/jennifersun98/Desktop/BioTIP_application/scApplicationData/data_Nestorowa.tsv", sep="\t", row.names=1)
dim(counts) 
...
load("subcounts.optimize_80per.rData")
```
...
<a name="Identifying Dynamic Network Biomodule (MCI)"></a>

__Identifying Dynamic Network Biomodule (MCI)__
...
<a name="Finding Tipping Point (Random Permutation and Delta Score)"></a>

__Finding Tipping Point (Random Permutation and Delta Score)__
...
We omitted executing MCI simulation plot because the size of the M matrix exceeds BioConductor file size limit. Below are the results obtained by running the command with downscaled C=10 and i=1. 


```{r, echo=FALSE, fig.align='center', out.width = '60%'}
knitr::include_graphics("MCI_simulation_10.jpg")
```
