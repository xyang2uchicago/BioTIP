...
githuburl = "https://raw.githubusercontent.com/xyang2uchicago/BioTIP_application/master/scApplicationData/data_Nestorowa.tsv"
counts = read.table(url(githuburl), sep="\t", row.names=1)
dim(counts) 
...
githuburl = "https://github.com/xyang2uchicago/BioTIP_application/blob/master/scApplicationData/cor.shrink_M.RData?raw=true"
load(url(githuburl))
dim(M)
